...
export type ValidConsonantPhonemes = 
      "B"
    | "CH"
    | "D"
    | "F"
...
export class TrunicConsonant {
    static get stroke_paths(): Record<ValidConsonantPhonemes, ConsonantEdgeNames[]> {
        return {
    ...
    static get valid() {
        return Object.keys(TrunicConsonant.stroke_paths) as ValidConsonantPhonemes[];
    }
    ...
    getStrokeCoordinates(phoneme: ValidConsonantPhonemes) {
        const stroke_path = TrunicConsonant.stroke_paths[phoneme] ?? [];
